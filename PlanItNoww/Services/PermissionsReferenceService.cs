...
namespace PlanItNoww.Services
{
    public class PermissionsReferenceService
    {
        ...
        public async Task<List<PermissionsReference>> SelectTransaction(IDb db, PermissionsReferenceSelectReq req)
        {
            ...
            string query = @"
                SELECT id, bitposition, value, description, name, version, notes, createdby, createdon, 
                       modifiedby, modifiedon, attributes, isactive, issuspended
        ...
        public async Task InsertTransaction(IDb db, PermissionsReference permissionsreference)
        {
            String query = @"
                INSERT INTO PermissionsReference (
                    bitposition, value, description, name, version, notes, createdby, createdon, 
                    modifiedby, modifiedon, attributes, isactive, issuspended
                )
                VALUES (
                   @bitposition, @value, @description, @name, @version, @notes, @createdby, @createdon, 
            ...
            permissionsreference.createdby = requeststate.usercontext.userid;
            permissionsreference.modifiedon = DateTime.UtcNow;
            permissionsreference.modifiedby = requeststate.usercontext.userid;
            ...
            db.AddParameter(command, "attributes", DbTypes.Types.Json).Value = permissionsreference.attributes_json;
        ...
        public async Task<bool> UpdateTransaction(IDb db, PermissionsReference permissionsreference)
        {
            ...
            String query = @"
                ...
                SET 
                    bitposition = @bitposition, value = @value, description = @description, name = @name, 
                    version = @version, notes = @notes, createdby = @createdby, createdon = @createdon, 
