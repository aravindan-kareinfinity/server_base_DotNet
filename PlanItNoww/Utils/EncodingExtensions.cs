...
namespace PlanItNoww.Utils
{
    public static class EncodingExtensions
    {
        ...
        {
            return System.BitConverter.GetBytes(original).ToBase62();
        }
        public static long LongFromBase62(this string original)
        {
            return System.BitConverter.ToInt64(original.FromBase62(), 0);
        }
    }
